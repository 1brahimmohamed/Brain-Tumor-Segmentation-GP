...
const SequenceSynthesisTab = () => {
    ...
    const handleSynthesisButtonClick = () => {
        ...
        const sequencesKeys = Object.keys(sequenceSynthesisSequencesState).filter(seq => seq !== sequenceSynthesisSequencesState.missing.value);
        const reqBody: any = {};
        ...
        if (studyData) {
            store.dispatch(postNewSynthesisRequestThunk(selectedModel.url, studyData[0].studyInstanceUid, reqBody));
        }
    }
            ...
            <div>
                ...
                >
...

                    {
                        ...
                        <SequenceSelection
                            sequences={
                                options.filter(option => option.value !== sequenceSynthesisSequencesState.missing.value)
