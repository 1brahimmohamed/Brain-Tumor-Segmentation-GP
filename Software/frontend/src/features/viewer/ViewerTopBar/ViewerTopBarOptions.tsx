...
import {annotationToolsNames} from "@utilities/AnnotationTools.ts";
...
const ViewerTopBarOptions = [
    {
        ...
        doPopDown: true,
        isClickable: true,
        toolName: annotationToolsNames.window,
    ...
    },
    {
        ...
        doPopDown: true,
        isClickable: true,
        toolName: annotationToolsNames.pan,
    ...
    },
    {
        ...
        doPopDown: true,
        isClickable: true,
        toolName: annotationToolsNames.zoom,
        ...
        children: [
            {
                icon: <RxAngle/>,
                text: "Angle",
                toolName: annotationToolsNames.angle,
            ...
            },
            {
                ...
                text: "Ellipse",
                toolName: annotationToolsNames.ellipticalROI,
                onClickAction: () => {console.log("ellipse")}
            },
            {
                icon: <RectangleOutlinedIcon/>,
                text: "Rectangle",
                toolName: annotationToolsNames.rectangleROI,
                onClickAction: () => {console.log("rectangle")}
            },
            {
                icon: <CallMadeIcon/>,
                text: "arrow",
                toolName: annotationToolsNames.arrowAnnotate,
    ...
    },
    {
        ...
        doPopDown: true,
        isClickable: true,
        // toolName: annotationToolsNames.rotate,
        children: [
            {
