            ...
            <div>
                ...
                <dl className="mt-6 space-y-6 divide-y divide-AASecondShade border-t border-AAPrimary text-sm leading-6">
                    <div className="pt-6 sm:flex">
                        <dt className="font-medium text-gray-300 sm:w-64 sm:flex-none sm:pr-6">Full name
                        </dt>
                    ...
                    <div className="pt-6 sm:flex">
                        <dt className="font-medium text-gray-300 sm:w-64 sm:flex-none sm:pr-6">Email
                            address
                        </dt>
                        <dd className="mt-1 flex justify-between gap-x-6 sm:mt-0 sm:flex-auto">
