...
const Modal = ({
    ...
    const renderHeader = () => {
        return (
            <>
                ...
                {title && (
                    <header className="bg-AAFirstShade flex items-center rounded-tl rounded-tr px-5 py-2">
                        <Typography
                            variant="h3"
                            color="secondary"
    ...
    return (
        <ReactModal
            className="relative max-h-full w-11/12 text-white outline-none lg:w-10/12  xl:w-6/12"
