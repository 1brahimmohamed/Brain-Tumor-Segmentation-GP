...
const navigation = [
    ...
    {name: 'Motion Artifacts Models', href: '/settings/motion-artifacts-models', icon: FaBrain, current: false},
                            ...
                            {navigation.map((item) => (
                                <li key={item.name}>
                                    ...
                                    >
                                        <item.icon
                                            className={classNames(
                                                item.current ? 'text-AAPrimary' : 'text-gray-300 group-hover:text-AAPrimary',
                                                'h-6 w-6 shrink-0'
                                            )}
                                            aria-hidden="true"
                                        />
