...
class NNUnet(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        if dice_mean >= self.best_mean:
            ...
            # json_file = '/media/workstation04/New Volume/MMMAI/NVIDIA_TRIAL2/fineTuning/without/best_epoch_learning_rate.json'
            # data_to_log = {'epoch': self.current_epoch , 'lr': self.learning_rate}
